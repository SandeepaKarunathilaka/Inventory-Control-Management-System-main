...
public class Product {
    ...
    public static class Builder {
        ...
        public Product build() {
            return new Product(id, name, sku, price, stockQuantity, description, expiryDate, imageUrl, category, supplier);
        }
    }
    ...
    public Product(Long id, String name, String sku, BigDecimal price, Integer stockQuantity, String description,
                   LocalDateTime expiryDate, String imageUrl, Category category, Supplier supplier) {
        this.id = id;
        this.name = name;
        this.sku = sku;
        this.price = price;
